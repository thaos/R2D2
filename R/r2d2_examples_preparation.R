...
#
# r2d2_example <- list(
#   bc1d_cal = BC1d_JAN_79_97,
#   bc1d_val = BC1d_JAN_98_16,
#   ref_cal= Ref_JAN_79_97,
#   ref_val = Ref_JAN_98_16,
#   dates_cal = sprintf("%04d-%02d-%02d", DATES_JAN_79_97$Y, DATES_JAN_79_97$m, DATES_JAN_79_97$d),
...
#devtools::use_data(r2d2_example)
